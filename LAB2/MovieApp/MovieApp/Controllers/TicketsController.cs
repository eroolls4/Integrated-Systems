...
namespace MovieApp.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddProductToCart(AddToOrderDTO model)
        {
            ...
            if (userId != null)
            {
                ...
                var selectedProduct = await _context.Tickets.FirstOrDefaultAsync(z => z.Id == model.SelectedTicketId);

                if (selectedProduct != null && userCart != null)
                {
                    userCart.TicketsInOrders?.Add(new TicketInOrder
                    {
